      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-emerald-600 mb-2">SRQ-29 Kuesioner</h1>
          ...
          <div className="mb-6">
            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
              <h3 className="font-semibold text-emerald-800 mb-2">Informasi Responden:</h3>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-sm">
                ...
                <div><span className="font-medium">Pekerjaan:</span> {personalInfo.occupation}</div>
                <div><span className="font-medium">Alamat:</span> {personalInfo.address}</div>
              </div>
            </div>
          </div>
              ...
              <div key={index} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start mb-3">
                  <h3 className="font-medium text-gray-800 flex-1 pr-4">
                    <span className="text-emerald-600 font-semibold">{index + 1}.</span> {question}
                  </h3>
                </div>
                ...
                <div className="flex space-x-4">
                  <label className="flex items-center space-x-2 cursor-pointer">
                    ...
                    />
                    <span className="text-sm font-medium text-emerald-600">YA</span>
                  </label>
          ...
          <div className="flex justify-between items-center mt-8 pt-6 border-t">
            ...
            <button
              ...
              className="px-6 py-3 bg-emerald-600 text-white rounded-lg font-medium hover:bg-emerald-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
            >
              Lihat Hasil
            </button>
          </div>
